...
const agregarProductoFav = async (idUsuario, idProducto) => {
  ...
  if (!favoritos) {
    return {
      msg: 'Lista de favoritos no encontrada',
      statusCode: 404
    };
  }
...
const result = await preference.create({
  body:{
    ...
    back_urls:{
      success:'netlify/frontend/carrito/success',
      failure:'netlify/frontend/carrito/failure',
      pending:'netlify/frontend/carrito/pending'
    },
